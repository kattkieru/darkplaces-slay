...
#ifdef __APPLE__
	/* kiki note:
	as part of the deprecation of OpenGL in modern macOS you can't
	create an OpenGL context unless you mark it as core profile. 
	also in my experience, context that aren't either 3.3 or 4.1 
	either don't work well or don't work at all.
	*/
